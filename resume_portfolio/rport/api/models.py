...
class SqlExamples(models.Model):
    index = models.BigIntegerField(
        primary_key=True, db_column="index", blank=True, null=False
    )
    difficulty = models.TextField(
        db_column="Difficulty", blank=True, null=True
    )  # Field name made lowercase.
    question = models.TextField(
        db_column="Question", blank=True, null=True
    )  # Field name made lowercase.
    solution = models.TextField(
        db_column="Solution", blank=True, null=True
    )  # Field name made lowercase.
...
class AnimalCrossingNewHorizonCatalogAccessories(models.Model):
    ...
    variation = models.TextField(
        db_column="Variation", blank=True, null=True
    )  # Field name made lowercase.
    diy = models.TextField(
        db_column="DIY", blank=True, null=True
    )  # Field name made lowercase.
    buy = models.TextField(
        db_column="Buy", blank=True, null=True
    )  # Field name made lowercase.
    sell = models.BigIntegerField(
        db_column="Sell", blank=True, null=True
    )  # Field name made lowercase.
    color_1 = models.TextField(
        db_column="Color 1", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    color_2 = models.TextField(
        db_column="Color 2", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    size = models.TextField(
        db_column="Size", blank=True, null=True
    )  # Field name made lowercase.
    miles_price = models.TextField(
        db_column="Miles Price", blank=True, null=True
    ...
    source_notes = models.TextField(
        db_column="Source Notes", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    seasonal_availability = models.TextField(
        db_column="Seasonal Availability", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    mannequin_piece = models.TextField(
        db_column="Mannequin Piece", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    version = models.TextField(
        db_column="Version", blank=True, null=True
    )  # Field name made lowercase.
    style = models.TextField(
        db_column="Style", blank=True, null=True
    )  # Field name made lowercase.
    label_themes = models.TextField(
        db_column="Label Themes", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    type = models.TextField(
        db_column="Type", blank=True, null=True
    )  # Field name made lowercase.
    villager_equippable = models.TextField(
        db_column="Villager Equippable", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    catalog = models.TextField(
        db_column="Catalog", blank=True, null=True
    )  # Field name made lowercase.
    filename = models.TextField(
        db_column="Filename", blank=True, null=True
    )  # Field name made lowercase.
    internal_id = models.BigIntegerField(
        db_column="Internal ID", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    unique_entry_id = models.TextField(
        db_column="Unique Entry ID", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
...
class AnimalCrossingNewHorizonCatalogAchievements(models.Model):
    ...
    award_criteria = models.TextField(
        db_column="Award Criteria", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    field_field = models.BigIntegerField(
        db_column="#", blank=True, null=True
    ...
    internal_name = models.TextField(
        db_column="Internal Name", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    internal_category = models.TextField(
        db_column="Internal Category", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    num_of_tiers = models.BigIntegerField(
        db_column="Num of Tiers", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    tier_1 = models.BigIntegerField(
        db_column="Tier 1", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    tier_2 = models.BigIntegerField(
        db_column="Tier 2", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    tier_3 = models.BigIntegerField(
        db_column="Tier 3", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    tier_4 = models.BigIntegerField(
        db_column="Tier 4", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    tier_5 = models.BigIntegerField(
        db_column="Tier 5", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    reward_tier_1 = models.BigIntegerField(
        db_column="Reward Tier 1", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    reward_tier_2 = models.BigIntegerField(
        db_column="Reward Tier 2", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    reward_tier_3 = models.BigIntegerField(
        db_column="Reward Tier 3", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    reward_tier_4 = models.BigIntegerField(
        db_column="Reward Tier 4", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    reward_tier_5 = models.BigIntegerField(
        db_column="Reward Tier 5", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    reward_tier_6 = models.BigIntegerField(
        db_column="Reward Tier 6", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    sequential = models.TextField(
        db_column="Sequential", blank=True, null=True
    )  # Field name made lowercase.
    version = models.TextField(
        db_column="Version", blank=True, null=True
    )  # Field name made lowercase.
...
class AnimalCrossingNewHorizonCatalogArt(models.Model):
    ...
    genuine = models.TextField(
        db_column="Genuine", blank=True, null=True
    )  # Field name made lowercase.
    ...
    real_artwork_title = models.TextField(
        db_column="Real Artwork Title", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    artist = models.TextField(
        db_column="Artist", blank=True, null=True
    )  # Field name made lowercase.
    museum_description = models.TextField(
        db_column="Museum Description", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    source = models.TextField(
        db_column="Source", blank=True, null=True
    )  # Field name made lowercase.
    ...
    hha_concept_1 = models.TextField(
        db_column="HHA Concept 1", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    hha_concept_2 = models.TextField(
        db_column="HHA Concept 2", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    hha_series = models.TextField(
        db_column="HHA Series", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters. This field type is a guess.
    hha_set = models.TextField(
        db_column="HHA Set", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters. This field type is a guess.
    interact = models.TextField(
        db_column="Interact", blank=True, null=True
    )  # Field name made lowercase.
    tag = models.TextField(
        db_column="Tag", blank=True, null=True
    )  # Field name made lowercase.
    speaker_type = models.TextField(
        db_column="Speaker Type", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    lighting_type = models.TextField(
        db_column="Lighting Type", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    catalog = models.TextField(
        db_column="Catalog", blank=True, null=True
    )  # Field name made lowercase.
...
class AnimalCrossingNewHorizonCatalogDressUp(models.Model):
    ...
    primary_shape = models.TextField(
        db_column="Primary Shape", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    secondary_shape = models.TextField(
        db_column="Secondary Shape", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    filename = models.TextField(
        db_column="Filename", blank=True, null=True
    )  # Field name made lowercase.
...
class AnimalCrossingNewHorizonCatalogFencing(models.Model):
    ...
    stack_size = models.BigIntegerField(
        db_column="Stack Size", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    buy = models.TextField(
        db_column="Buy", blank=True, null=True
    )  # Field name made lowercase.
...
class AnimalCrossingNewHorizonCatalogFish(models.Model):
    ...
    where_how = models.TextField(
        db_column="Where/How", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    shadow = models.TextField(
        db_column="Shadow", blank=True, null=True
    )  # Field name made lowercase.
    total_catches_to_unlock = models.BigIntegerField(
        db_column="Total Catches to Unlock", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    spawn_rates = models.TextField(
        db_column="Spawn Rates", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    rain_snow_catch_up = models.TextField(
        db_column="Rain/Snow Catch Up", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    nh_jan = models.TextField(
        db_column="NH Jan", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    nh_feb = models.TextField(
        db_column="NH Feb", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    nh_mar = models.TextField(
        db_column="NH Mar", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    nh_apr = models.TextField(
        db_column="NH Apr", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    nh_may = models.TextField(
        db_column="NH May", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    nh_jun = models.TextField(
        db_column="NH Jun", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    nh_jul = models.TextField(
        db_column="NH Jul", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    nh_aug = models.TextField(
        db_column="NH Aug", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    nh_sep = models.TextField(
        db_column="NH Sep", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    nh_oct = models.TextField(
        db_column="NH Oct", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    nh_nov = models.TextField(
        db_column="NH Nov", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    nh_dec = models.TextField(
        db_column="NH Dec", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    sh_jan = models.TextField(
        db_column="SH Jan", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    sh_feb = models.TextField(
        db_column="SH Feb", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    sh_mar = models.TextField(
        db_column="SH Mar", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    sh_apr = models.TextField(
        db_column="SH Apr", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    sh_may = models.TextField(
        db_column="SH May", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    sh_jun = models.TextField(
        db_column="SH Jun", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    sh_jul = models.TextField(
        db_column="SH Jul", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    sh_aug = models.TextField(
        db_column="SH Aug", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    sh_sep = models.TextField(
        db_column="SH Sep", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    sh_oct = models.TextField(
        db_column="SH Oct", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    sh_nov = models.TextField(
        db_column="SH Nov", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    sh_dec = models.TextField(
        db_column="SH Dec", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    color_1 = models.TextField(
        db_column="Color 1", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    ...
    icon_filename = models.TextField(
        db_column="Icon Filename", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    critterpedia_filename = models.TextField(
        db_column="Critterpedia Filename", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    furniture_filename = models.TextField(
        db_column="Furniture Filename", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    internal_id = models.BigIntegerField(
        db_column="Internal ID", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
...
class AnimalCrossingNewHorizonCatalogFloors(models.Model):
    ...
    vfx = models.TextField(
        db_column="VFX", blank=True, null=True
    )  # Field name made lowercase.
    diy = models.TextField(
        db_column="DIY", blank=True, null=True
    )  # Field name made lowercase.
...
class AnimalCrossingNewHorizonCatalogFossils(models.Model):
    ...
    museum = models.TextField(
        db_column="Museum", blank=True, null=True
    )  # Field name made lowercase.
    version = models.TextField(
        db_column="Version", blank=True, null=True
    )  # Field name made lowercase.
...
class AnimalCrossingNewHorizonCatalogHousewares(models.Model):
    ...
    body_title = models.TextField(
        db_column="Body Title", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    pattern = models.TextField(
        db_column="Pattern", blank=True, null=True
    )  # Field name made lowercase.
    pattern_title = models.TextField(
        db_column="Pattern Title", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    diy = models.TextField(
        db_column="DIY", blank=True, null=True
    )  # Field name made lowercase.
    body_customize = models.TextField(
        db_column="Body Customize", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    pattern_customize = models.TextField(
        db_column="Pattern Customize", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    kit_cost = models.TextField(
        db_column="Kit Cost", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters. This field type is a guess.
    buy = models.TextField(
        db_column="Buy", blank=True, null=True
    )  # Field name made lowercase.
    ...
    outdoor = models.TextField(
        db_column="Outdoor", blank=True, null=True
    )  # Field name made lowercase.
    speaker_type = models.TextField(
        db_column="Speaker Type", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    ...
    variant_id = models.TextField(
        db_column="Variant ID", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    internal_id = models.BigIntegerField(
        db_column="Internal ID", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
...
class AnimalCrossingNewHorizonCatalogInsects(models.Model):
    ...
    weather = models.TextField(
        db_column="Weather", blank=True, null=True
    )  # Field name made lowercase.
    total_catches_to_unlock = models.BigIntegerField(
        db_column="Total Catches to Unlock", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
...
class AnimalCrossingNewHorizonCatalogPhotos(models.Model):
    ...
    customize = models.TextField(
        db_column="Customize", blank=True, null=True
    )  # Field name made lowercase.
    kit_cost = models.BigIntegerField(
        db_column="Kit Cost", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    buy = models.TextField(
        db_column="Buy", blank=True, null=True
...
class AnimalCrossingNewHorizonCatalogRecipes(models.Model):
    ...
    recipes_to_unlock = models.BigIntegerField(
        db_column="Recipes to Unlock", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    version = models.TextField(
        db_column="Version", blank=True, null=True
    )  # Field name made lowercase.
    ...
    serial_id = models.BigIntegerField(
        db_column="Serial ID", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    internal_id = models.BigIntegerField(
        db_column="Internal ID", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
...
class AnimalCrossingNewHorizonCatalogTools(models.Model):
    ...
    uses = models.TextField(
        db_column="Uses", blank=True, null=True
    )  # Field name made lowercase.
    stack_size = models.BigIntegerField(
        db_column="Stack Size", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    ...
    set = models.TextField(
        db_column="Set", blank=True, null=True
    )  # Field name made lowercase.
    miles_price = models.TextField(
        db_column="Miles Price", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters. This field type is a guess.
...
class AnimalCrossingNewHorizonCatalogVillagers(models.Model):
    ...
    species = models.TextField(
        db_column="Species", blank=True, null=True
    )  # Field name made lowercase.
    gender = models.TextField(
        db_column="Gender", blank=True, null=True
    )  # Field name made lowercase.
    personality = models.TextField(
        db_column="Personality", blank=True, null=True
    )  # Field name made lowercase.
    hobby = models.TextField(
        db_column="Hobby", blank=True, null=True
    )  # Field name made lowercase.
    birthday = models.TextField(
        db_column="Birthday", blank=True, null=True
    )  # Field name made lowercase.
    catchphrase = models.TextField(
        db_column="Catchphrase", blank=True, null=True
    )  # Field name made lowercase.
    favorite_song = models.TextField(
        db_column="Favorite Song", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    style_1 = models.TextField(
        db_column="Style 1", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    style_2 = models.TextField(
        db_column="Style 2", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    color_1 = models.TextField(
        db_column="Color 1", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    ...
    wallpaper = models.TextField(
        db_column="Wallpaper", blank=True, null=True
    )  # Field name made lowercase.
    flooring = models.TextField(
        db_column="Flooring", blank=True, null=True
    )  # Field name made lowercase.
    furniture_list = models.TextField(
        db_column="Furniture List", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    filename = models.TextField(
        db_column="Filename", blank=True, null=True
    )  # Field name made lowercase.
...
class AnimalCrossingNewHorizonCatalogWallMounted(models.Model):
    ...
    door_deco = models.TextField(
        db_column="Door Deco", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    catalog = models.TextField(
        db_column="Catalog", blank=True, null=True
    )  # Field name made lowercase.
...
class AnimalCrossingNewHorizonCatalogWallpaper(models.Model):
    ...
    vfx_type = models.TextField(
        db_column="VFX Type", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    diy = models.TextField(
        db_column="DIY", blank=True, null=True
    )  # Field name made lowercase.
    ...
    window_type = models.TextField(
        db_column="Window Type", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    window_color = models.TextField(
        db_column="Window Color", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    pane_type = models.TextField(
        db_column="Pane Type", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    curtain_type = models.TextField(
        db_column="Curtain Type", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    curtain_color = models.TextField(
        db_column="Curtain Color", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    ceiling_type = models.TextField(
        db_column="Ceiling Type", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
    hha_concept_1 = models.TextField(
        db_column="HHA Concept 1", blank=True, null=True
    )  # Field name made lowercase. Field renamed to remove unsuitable characters.
